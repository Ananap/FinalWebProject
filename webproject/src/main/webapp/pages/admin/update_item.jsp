            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <textarea required rows="5" class="form-control"
                              ...
                              placeholder="${locale_main_description}">${flower.description}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select required title="${flower.flowerType}" id="category" name="category"
                                class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input required value="${flower.watering}" type="text" min="0"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input required type="text" class="form-control" id="country"
                               name="country" value="${flower.originCountry}"
                               placeholder="${locale_country_name}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            ...
                            <input required value="${flower.price}" type="text" step="0.1" min="1"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input required value="${flower.storage.count}" type="text" min="1" max="99"
